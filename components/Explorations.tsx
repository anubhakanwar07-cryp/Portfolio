      ...
      <div className="max-w-[1240px] mx-auto px-10 max-[480px]:px-5">
        ...
        <div className="explore-scroll flex gap-5 overflow-x-auto pb-2.5">
          {items.map((item) => (
            <div
              key={item.title}
              className="shrink-0 w-[280px] rounded-[18px] border border-line bg-cream p-[26px] flex flex-col gap-3.5 transition-[transform,box-shadow] hover:-translate-y-1 hover:shadow-[0_14px_30px_-20px_rgba(24,21,15,0.3)]"
            >
