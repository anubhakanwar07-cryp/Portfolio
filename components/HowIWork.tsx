...
const cards = [
  {
    ...
    body: "I stress-test scope with data before committing engineering time. A sales funnel RCA across 300K+ leads once turned into four concrete, actionable hypotheses — that's the bar I hold every “should we build this” question to.",
    tag: "Discover",
    dark: true,
  },
  {
    ...
    body: "When a v1 needs to exist, I build it myself. EmStudio, PitchMate, and Socrates were all coded solo using Claude, GPT, and Cursor — no hand-off required to prove an idea, and no black-box logic either.",
    tag: "Build",
    dark: false,
  },
  {
